...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <br>
            <form class="user" action="../routers/r_pesanan.php?aksi=insert" method="post" enctype="multipart/form-data">
                <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" name="id" id="id" hidden>
                    <div class="form-group ">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Menu" name="menu">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="text" name="status" id="status" value="unprogress" hidden>
                    <br>
                    <br>
